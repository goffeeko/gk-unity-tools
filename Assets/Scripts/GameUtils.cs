...
// 全局别名，让用户可以直接使用GameUtils而不需要GK前缀
...
namespace GK
{
    ...
    public static class GameUtils
    {
        ...
        {
            UnityEngine.Debug.Log("[GK] Initializing GameUtils...");
            ...
            UnityEngine.Debug.Log($"[GK] GameUtils initialized for platform: {PlatformDetector.GetPlatformName()}");
        }
